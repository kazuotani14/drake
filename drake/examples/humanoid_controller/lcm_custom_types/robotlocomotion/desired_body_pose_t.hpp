...
#ifndef __robotlocomotion_desired_body_pose_t_hpp__
#define __robotlocomotion_desired_body_pose_t_hpp__
...
uint64_t desired_body_pose_t::_computeHash(const __lcm_hash_ptr *p)
{
    ...
    for(fp = p; fp != NULL; fp = fp->parent)
        if(fp->v == desired_body_pose_t::getHash)
            return 0;
    const __lcm_hash_ptr cp = { p, (void*)desired_body_pose_t::getHash };
